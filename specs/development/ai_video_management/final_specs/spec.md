...
- **FR-1** Backend libs at `projects/ai_video_management/backend/libs/`: `repo_root.py`, `file_reader.py`, `file_writer.py`, `promotions.py`, `safe_resolve.py`, `exposed_tree.py`, `tree_walker.py`, `regen_prompt.py`, `stages.py`, `api_security.py`, `api.py`, `sub_type_lookup.py`, `media_renamer.py` (follow-up 007), `media_archiver.py` (follow-up 008), `main.py`. **No `render_views.py`** (view dispatch is purely client-side).
