...
```text
0-11     -  | cat=suspense    | vol=0.5  | duck=on | fade=in       # 开场钩：穿越骤醒转冷、至暗压迫(shot01)
11-35    -  | cat=tension     | vol=0.55 | duck=on | fade=in       # 高座宣判除族 + 裴昭奚落冷峙(shot02-03)
35-44    -  | cat=tragic      | vol=0.5  | duck=on | fade=in/out   # 回忆：救弟挡掌、丹田碎裂、家人变脸(shot04)
